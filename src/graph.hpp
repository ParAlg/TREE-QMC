...
public:
  ...
  static inline parlay::internal::timer t;
...
private:
  ...
  weight_t ***graph;
  weight_t sdp_cut(weight_t alpha, std::vector<index_t> *A,
...
extern std::ofstream subproblem_csv, quartets_txt, good_edges_txt,
    bad_edges_txt;
